...
export const createJobPost = (jobData) => async (dispatch) => {
    try{
        ...
        const {data} = await axios.post("https://careerbridge-backend-94u7.onrender.com/api/v1/create/job",jobData,config) ;        
...
export const getAllJobs = () => async (dispatch) => {
    try{
        ...
        const {data} = await axios.get("https://careerbridge-backend-94u7.onrender.com/api/v1/jobs") ;
...
export const getSingleJob = (id) => async (dispatch) => {
    try{
        ...
        const {data} = await axios.get(`https://careerbridge-backend-94u7.onrender.com/api/v1/job/${id}`) ;
...
export const saveJob = (id) => async (dispatch) => {
    try{
        ...
        const {data} = await axios.get(`https://careerbridge-backend-94u7.onrender.com/api/v1/saveJob/${id}`,config) ;
