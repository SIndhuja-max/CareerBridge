...
export const Contact = () => {
  ...
  return (
    <>
      <MetaData title="CareerBridge Contact" />
      <div className="bg-gray-950 min-h-screen pt-14 md:px-20 px-3 text-white">
        <div className="flex flex-col gap-5 md:px-0 px-2 md:pt-8 pt-4 pb-20">
          ...
          <div>
            ...
            <Card
              title="Address"
              content="CareerBridge, MG Road, Bengaluru, Karnataka, India"
            />
            <Card
              title="Email"
              content={[
  "General Inquiries: contact@careerbridge.com",
  "Support: support@careerbridge.com",
  "Recruitment: hiring@careerbridge.com",
]}
            />
            <Card
              title="Phone"
  ...
  "Recruitment Support: +91 98765 43211",
]}
            />
